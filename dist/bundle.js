var ipfsOnlyHashSdk = (() => {
  ...
  var require_rfc4648 = __commonJS({
    "node_modules/multibase/src/rfc4648.js"(exports2, module2) {
      "use strict";
      var decode8 = (string6, alphabet2, bitsPerChar) => {
        const codes = {};
...
`;
  ...
  var require_sha_browser = __commonJS({
    "node_modules/multihashing-async/src/sha.browser.js"(exports2, module2) {
      ...
      var crypto2 = self.crypto || /** @type {typeof window.crypto} */
  ...
  var require_base64 = __commonJS({
    "node_modules/@protobufjs/base64/index.js"(exports2) {
      ...
      base642.decode = function decode8(string6, buffer, offset) {
        var start = offset;
        var j = 0, t;
  ...
  var require_utf8 = __commonJS({
    "node_modules/@protobufjs/utf8/index.js"(exports2) {
      ...
      utf8.write = function utf8_write(string6, buffer, offset) {
        ...
        for (var i = 0; i < string6.length; ++i) {
          c1 = string6.charCodeAt(i);
          if (c1 < 128) {
            buffer[offset++] = c1;
          } else if (c1 < 2048) {
            buffer[offset++] = c1 >> 6 | 192;
            buffer[offset++] = c1 & 63 | 128;
          } else if ((c1 & 64512) === 55296 && ((c2 = string6.charCodeAt(i + 1)) & 64512) === 56320) {
  ...
  var require_unixfs = __commonJS({
    "node_modules/ipfs-unixfs/src/unixfs.js"(exports2, module2) {
      ...
      $root.Data = function() {
        ...
        Data.decode = function decode8(r, l) {
      ...
      $root.UnixTime = function() {
        ...
        UnixTime.decode = function decode8(r, l) {
          if (!(r instanceof $Reader))
            r = $Reader.create(r);
      ...
      $root.Metadata = function() {
        ...
        Metadata.decode = function decode8(r, l) {
          if (!(r instanceof $Reader))
            r = $Reader.create(r);
  ...
  var require_dag = __commonJS({
    "node_modules/ipld-dag-pb/src/dag.js"(exports2, module2) {
      ...
      $root.PBLink = function() {
        ...
        PBLink.decode = function decode8(r, l) {
          if (!(r instanceof $Reader))
            r = $Reader.create(r);
      ...
      $root.PBNode = function() {
        ...
        PBNode.decode = function decode8(r, l) {
          if (!(r instanceof $Reader))
            r = $Reader.create(r);
  ...
  var require_bases = __commonJS({
    "node_modules/ipld-dag-pb/node_modules/uint8arrays/util/bases.js"(exports2, module2) {
      ...
      function createCodec6(name4, prefix, encode7, decode8) {
        return {
          name: name4,
          prefix,
          encoder: {
  ...
  function createCodec5(name4, prefix, encode7, decode8) {
    return {
      name: name4,
      prefix,
      encoder: {
  ...
  // index.mjs
  var ipfs_hash_only_ipfs_exports = {};
  __export(ipfs_hash_only_ipfs_exports, {
    sdk: () => sdk
  });
  var sdk = require_ipfs_only_hash();
  return __toCommonJS(ipfs_hash_only_ipfs_exports);
})();
